...
**/
template<typename T> tDeviceRC OCLDWT<T>::setKernelArgsQuant(OCLKernel* myKernel, unsigned int level, unsigned int levels, float quantLL, float quantLH, float quantHH){
